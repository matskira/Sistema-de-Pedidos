...
import com.mpoda.cursomc.repositories.ItemPedidoRepository;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		ItemPedido ip1 = new ItemPedido(pedi1, prod1, 0.0, 1, 2000.00);
		ItemPedido ip2 = new ItemPedido(pedi2, prod3, 0.0, 2, 80.00);
		ItemPedido ip3 = new ItemPedido(pedi1, prod2, 100.0, 1, 800.00);
